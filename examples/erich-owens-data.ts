...
export const erichOwensCareerProfile: CareerProfile = {
  ...
  summary: "Mathematical problem-solver with 12 years at Meta oscillating between IC (Staff Engineer, Tech Lead) and leadership roles (managing up to 40 engineers) across ML, computer vision, VR/AR, and AI research. Built systems still in production a decade later—comment ranking algorithms, avatar generation pipelines, AR face tracking. Now CTO at Dolphin AI (drone/AI startup) and creator of 39 production-ready Claude Skills. Open to Senior IC or Leadership roles building transformative AI products at startups or big tech.",
  ...
  timelineEvents: [
    ...
    // Meta (12 years, multiple roles)
    {
      ...
      endDate: "2025-09",
      type: "role_change",
      title: "Engineering Manager / Tech Lead Manager - Facebook AI Editing",
      company: "Meta",
      description: "Managed mobile and ML engineers integrating computer vision and LLMs into composer and creation tools",
    ...
    },
    {
      ...
      company: "Meta",
      description: "Led GPT-3/Stable-Diffusion avatar customization team; managed 40 engineers across avatar pipeline, 3D geometry, technical art, and avatar ML",
      impact: "Scaled avatar systems to support Meta's VR ecosystem; shipped ML-powered avatar generation",
    ...
    },
    {
      ...
      endDate: "2022-06",
      type: "role_change",
      title: "Engineering Manager / Tech Lead Manager - XR Tech",
      company: "Meta",
    ...
    },
    {
      ...
      endDate: "2014-12",
      type: "role_change",
      title: "Engineer - News Feed Ranking",
      company: "Meta (Facebook)",
    ...
    },
    {
      ...
      description: "X-ray crystallography, powder diffraction, superelastic materials for cardiovascular implants",
      impact: "Research on medical device materials",
  ...
  projects: [
    ...
    },
    {
      ...
      description: "Built 'avatar from photo' system in 2 months for Facebook's first social VR app; hired ex-Pixar talent",
      technologies: ["Computer Vision", "3D Graphics", "VR", "Python", "C++"],
      impact: "Shipped company's best-reviewed avatars (FastCompany coverage); enabled Facebook's entry into social VR",
      metrics: ["2 months to production", "FastCompany featured", "Patent filed"],
      screenshot: "https://storage.googleapis.com/firecrawl-scrape-media/screenshot-7b1723ad-c8ce-42a3-89d0-f1a79183fa91.png"
    },
    {
      name: "Avatar Team at Meta",
      role: "Engineering Manager",
      description: "Managed 40+ engineers across avatar pipeline, 3D geometry, technical art, and avatar ML",
    ...
    {
      name: "Thermal Haptics for VR",
      role: "Hackathon Project → Building 8 Research",
      description: "Built peltier-cooled VR controllers providing hot/cold sensations ('fire and ice in VR')",
      technologies: ["VR", "Haptics", "Hardware", "C++"],
      impact: "Hackathon win; filed patent on thermal haptics; demonstrated novel haptic modality",
      metrics: ["Hackathon win", "Patent filed", "Novel haptic feedback"]
    },
    {
      name: "First CV-Based Newsfeed Personalization",
      role: "Engineer",
      description: "Built first CV-based filter for Facebook news feed using computer vision for content understanding",
...
export const erichOwensPositioning: PositioningStrategy = {
  positioning: {
    headline: "Mathematical Problem-Solver Who Jumps Domains (NLP→CV→VR→Medical AI→Drones) and Ships Systems That Last Decades",
    differentiators: [
    ...
    messaging: "Where most engineers specialize, Erich generalizes through mathematics. Where most build features, Erich builds systems that last. Where most choose IC or management, Erich oscillates based on impact. The result: decade-lasting infrastructure across wildly different domains."
  },
  visualStrategy: {
    aestheticDirection: "Windows 3.1 retro aesthetic—navy blue title bars, 3D beveled buttons, classic window chrome with happy optimistic accents (warm yellows, corals)",
    avoid: ["sterile corporate", "generic tech portfolio", "flashy animations"],
    embrace: ["nostalgic computing", "90s optimism", "clean geometric forms", "readable typography"]
  },
  contentStrategy: {
    topics: ["AI/ML", "computer-vision", "3D-graphics", "VR/AR", "engineering-leadership", "product-development", "drones", "LLMs"],
    tone: "Confident technical storytelling—specific metrics (40 engineers, 10+ years in production, 2 months to MVP), concrete technologies (CLIP, GPT-3, FACS), proven impact (billions of users, human clinical trials)",
    depth: "Lead with scale and longevity (10+ years, 40 engineers), support with technical depth (patents, hackathons, papers), anchor with current momentum (CTO at Dolphin AI, 39 Claude Skills)"
  }
};
